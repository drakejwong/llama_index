...
from gpt_index.data_structs.data_structs import SpellbookIndexDict
from gpt_index.data_structs.data_structs_v2 import (
    KG, ChatGPTRetrievalPluginIndexDict, ChromaIndexDict, CompositeIndex,
    EmptyIndex, FaissIndexDict, IndexDict, IndexGraph, IndexList, KeywordTable,
    OpensearchIndexDict, PineconeIndexDict, QdrantIndexDict, SimpleIndexDict,
    V2IndexStruct, WeaviateIndexDict)
...
INDEX_STRUCT_TYPE_TO_INDEX_STRUCT_CLASS: Dict[
    IndexStructType, Type[V2IndexStruct]
] = {
    ...
    IndexStructType.SPELLBOOK: SpellbookIndexDict,
}
...
INDEX_STRUCT_TYPE_TO_INDEX_CLASS: Dict[IndexStructType, Type[BaseGPTIndex]] = {
    ...
    IndexStructType.SPELLBOOK: GPTSpellbookIndex,
}
...
def load_index_struct_from_dict(
    ...
    if type == IndexStructType.COMPOSITE:
        ...
        return CompositeIndex(
            all_index_structs=all_index_structs, root_id=root_id
        )
    else:
